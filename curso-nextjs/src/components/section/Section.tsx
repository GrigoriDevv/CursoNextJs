      ...
      >
        {variant === "h-list" && (
          <button
            ...
            className="h-14 w-14 bg-primary rounded-full flex items-center justify-center sticky my-auto left-0 -ml-14 disabled:opacity-0"
          >
        ...
        {items.map((item) => (
          <li
            className="w-full data-[variant=h-list]:sm-72"
            key={item.title}
            data-variant={variant}
          >
            <Card
